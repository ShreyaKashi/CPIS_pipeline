...
classifier_checkpoint_path = '/home/kashis/Desktop/Capstone/pipeline/pretrained_weights/resnet101_custom_dataset_4classes.pth'
...
def main():
    ...
    for img_name in tqdm(img_paths):
        ...
        for seg_mask in segments_in_img:
            ...
            classifier_model.fc = nn.Linear(num_features, num_classes)
